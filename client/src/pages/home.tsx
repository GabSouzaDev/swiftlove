      ...
      <section className="relative z-10 text-center py-16 px-6">
        ...
        >
          <h1 className="font-playfair text-5xl md:text-7xl font-bold text-gradient mb-6 animate-gentle-glow">
            {isSecretMode && secretLetterUnlocked ? "💎 Uma Carta Secreta Especial" : 
             fromName && toName !== "você" ? `" Uma Declaração de Amor de ${fromName} para ${toName}` : " Uma Declaração de Amor"}
          </h1>
          ...
          <p className="font-dancing text-2xl md:text-3xl text-deep-rose mb-8 love-text">
            {fromName && toName !== "você" ? "Uma carta musical do coração de um apaixonado" : "Uma carta musical do coração"}
          </p>
      ...
      <main className="relative z-10 px-6 pb-20">
        <div className="max-w-4xl mx-auto space-y-8">
          {isSecretMode && !secretLetterUnlocked ? (
            ...
            /* Carta Secreta no lugar da carta pública */
              ...
              return (
                ...
                >
                  ...
                  {paragraph.isFinal ? (
                    ...
                    <div className={`flex ${index % 2 === 0 ? 'justify-end' : 'justify-start'} mt-4`}>
                      <IconComponent className={`w-6 h-6 opacity-60 ${
                        index % 2 === 0 ? 'text-rose-gold' : 'text-romantic-gold'
                      }`} />
                    </div>
                  )}
                </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center space-x-6 text-sm text-gray-400">
            <span className="flex items-center">
              Feito com <Heart className="w-4 h-4 text-rose-gold mx-1 fill-current" /> especialmente para você
            </span>
            <span>•</span>
