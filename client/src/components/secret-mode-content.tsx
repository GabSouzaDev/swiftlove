...
export default function SecretModeContent({
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <p className="text-lg md:text-xl leading-relaxed text-gray-700 mb-4 love-text">
          Você tem 15 maridos e ainda consegue tempo pra mim… isso é praticamente um milagre interdimensional! Entre os compromissos com os sete do BTS (imagino que o V esteja encarregado do café da manhã, enquanto o Jungkook provavelmente está te ensinando a... sei lá, acertar um ponto preto no telhado? Porque sinceramente, nunca vi alguém dominar absolutamente tudo como esse cara), os treinos ninja com o Naruto, as patrulhas noturnas com Oliver Queen, as corridas temporais com Barry Allen e as missões aquáticas com Percy Jackson — que, aliás, deve estar te levando pra um passeio no campo de morangos só pra te ver sorrir — ainda sobra espaço pra se perder nos olhos do Andrew Garfield, que insiste em te mostrar o lado mais doce do multiverso...<br/><br/>
          E nas sombras de Sung Jin-Woo, que te protege com um exército inteiro, provavelmente já colocou um shadow pra segurar suas coisas, outro pra te buscar café, e mais uns três só pra garantir que ninguém ouse te atormentar no meio da rua. Ele leva a segurança tão a sério que até o Wi-Fi perto de você tem criptografia rank S...
          E eu? Fico aqui torcendo pra ser o único que não precisa salvar o mundo… só o seu coração 💛. Mas tudo bem, eu aceito ser o último da fila. Porque no final, sou eu quem vai estar ao seu lado quando os créditos finais subirem. E prometo: sem efeitos especiais, só amor real.
        </p>
        <div className="flex justify-end mt-4">
          <Heart className="w-6 h-6 opacity-60 text-rose-gold" />
        </div>
